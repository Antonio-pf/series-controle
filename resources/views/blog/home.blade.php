            ...
            <div class="tab-class mb-4">
                <div class="row g-4">
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="whats-carousel owl-carousel owl-loaded owl-drag">





                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2140px, 0px, 0px); transition: all 2s ease 0s; width: 4708px;"><div class="owl-item cloned" style="width: 403px; margin-right: 25px;"><div class="whats-item">
                                        ...
                                        </div></div><div class="owl-item cloned" style="width: 403px; margin-right: 25px;"><div class="whats-item">
                                            <div class="bg-light rounded">
                                                <div class="rounded-top overflow-hidden">
                                        ...
                                        </div></div><div class="owl-item" style="width: 403px; margin-right: 25px;"><div class="latest-news-item">
                                            <div class="bg-light rounded">
                                                <div class="rounded-top overflow-hidden">
                                        ...
                                        </div></div><div class="owl-item" style="width: 403px; margin-right: 25px;"><div class="whats-item">
                                            <div class="bg-light rounded">
                                                <div class="rounded-top overflow-hidden">
                                        ...
                                        </div></div><div class="owl-item active" style="width: 403px; margin-right: 25px;"><div class="whats-item">
                                            <div class="bg-light rounded">
                                                <div class="rounded-top overflow-hidden">
                                                    <img src="img/news-3.jpg" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                                </div>
                                        ...
                                        </div></div><div class="owl-item cloned" style="width: 403px; margin-right: 25px;"><div class="latest-news-item">
                                            <div class="bg-light rounded">
                                                <div class="rounded-top overflow-hidden">
                                                    <img src="img/news-7.jpg" class="img-zoomin img-fluid rounded-top w-100" alt="">
                                                </div>
